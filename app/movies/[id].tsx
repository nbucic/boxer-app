...
const MovieInfo = ({ label, value }: MovieInfoProps) => (
  <View className='flex-col items-start justify-center mt-5'>
    ...
    <Text className='text-light-100 font-bolt text-sm mt-2'>
      {value || 'N/A'}
    </Text>
  </View>
)
...
const MovieDetails = () => {
  ...
  return (
    <View className='bg-primary flex-1'>
      ...
      <TouchableOpacity className='absolute bottom-5 left-5 right-0 mx-5 bg-accent rounded-lg py-3.5 flex flex-row items-center justify-center z-50'
        onPress={router.back}>
